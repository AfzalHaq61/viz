                ...
                <div class="col-12">
                    <div class="header__wrapper">
                        ...
                        <div class="header__left d-flex align-items-center">
                            <div class="logo_img">
                                <a href="{{url('/')}}">
                                    <img class="p-2" style="width: 150px" src="{{getLogoImage(Settings('logo') )}}" alt="{{ Settings('site_name')  }}">
                                </a>
                            </div>
                            <div class="mr-3 translator-switch">
                                ...
                                <select name="code" id="language_code" class="nice_Select" onchange="location = this.value;">
                                    ...
                                    <option value="{{route('changeLanguage',$language->code)}}" @if ($currentLang==$language->code) selected @endif>{{$language->name }}
                                    </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="category_search d-flex category_box_iner">
                                ...
                                <form action="{{route('search')}}">
                                    <div class="input-group theme_search_field">
                                        ...
                                        <input type="text" class="form-control" name="query" placeholder="{{__('frontend.Search for course, skills and Videos')}}" onfocus="this.placeholder = ''" onblur="this.placeholder = '{{__('frontend.Search for course, skills and Videos')}}'">
                                ...
                                <ul id="mobile-menu">
                                    ...
                                    <li class="@if($menu->mega_menu==1) position-static @else @if($menu->show==1) right_control_submenu @endif @endif">
                                        ...
                                        <ul class="mega_menu submenu ">
                                            <li class="container mx-auto">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-{{$menu->mega_menu_column}}">
                                                        <h4>
                                                            {{$sub->title}}
                                                        </h4>
                                                        @if(isset($sub->childs))
                                        ...
                                        <ul class="submenu list">
                                            @foreach($menu->childs as $sub)
                                            <li class=""><a @if($sub->is_newtab==1) target="_blank"
                        ...
                        <div class="header__right">
                            <div class="contact_wrap d-flex align-items-center">
                                <div class="contact_btn">
                                    <a href="{{url('login')}}" class="theme_btn small_btn2">{{__('frontend.Sign In')}} </a>
                                </div>
                            </div>
                        </div>
                        @endguest
