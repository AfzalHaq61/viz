        ...
        <div class="container-fluid p-0">
            <div class="row">
                ...
                <div class="@if($course->type==1)col-md-12 @else col-md-12  @endif ">
                                                    ...
                                                    <div class="col-xl-6 courseBox mb-25">
                                                        <div class="primary_input  ">
                                                            ...
                                                            <div class="row  ">
                                                                <div class="col-md-12">
                                                                    <label class="primary_input_label mt-1"
                                                                           for=""> {{__('common.Future course')}}</label>
                                                                </div>
                                                                <div class="col-md-3 mb-25">
                                                                    <label class="primary_checkbox d-flex mr-12"
                                                                           for="future_course0">
                                                                        <input type="radio"
                                                                               ...
                                                                               id="future_course0"
                                                                               name="future_course"
                                                                               value="0" {{@$course->future_course==0?"checked":""}}>
                                                                        <span
                                                                            class="checkmark mr-2"></span> {{__('common.No')}}
                                                                    </label>
                                                                </div>
                                                                <div class="col-md-3 mb-25">
                                                                    ...
                                                                    <label class="primary_checkbox d-flex mr-12"
                                                                        ...
                                                                        <input type="radio"
                                                                               ...
                                                                               id="future_course1"
                                                                               name="future_course"
                                                                               value="1" {{@$course->future_course==1?"checked":""}}>
                    ...
                    <h4 class="home_page_heading">{{__('courses.Home Page Details')}}</h4>
                </div>
                ...
                <div class="row mt-20">
                    <div class="col-xl-12">
                        <div class="primary_input_input_label">
                            ...
                            <div class="primary_file_uploader">
                                <input class="primary-input filePlaceholder" type="text" id="" value="{{showPicName(@$course->course_background_image)}}" placeholder="Browse Image file" readonly="">
                                <button class="" type="button">
                ...
                <div class="row mt-20">
                    <div class="col-xl-12">
                        <div class="primary_input_input_label">
                            ...
                            <div class="primary_file_uploader">
                                <input class="primary-input filePlaceholder" type="text" id="" value="{{showPicName(@$course->course_icon)}}" placeholder="Browse Image file" readonly="">
                                <button class="" type="button">
                ...
                <div class="row mt-20">
                    <div class="col-xl-12">
                        <div class="primary_input mb-25">
                            ...
                            <div class="mb-20"><input class="primary_input_field" name="course_feature[]" value="{{$course_feature}}" placeholder="-" id="course_feature" type="text" value=""></div>
                            @endforeach
                            @endif
