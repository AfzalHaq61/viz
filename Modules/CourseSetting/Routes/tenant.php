...
//    Route::get('/edit/course/{id}', 'CourseSettingController@editCourse')->name('addNewCourse')->middleware('RoutePermissionCheck:addNewCourse');
    ...
    Route::get('/future/courses', 'CourseSettingController@getFutureCourse')->name('getFutureCourse')->middleware('RoutePermissionCheck:getFutureCourse');
    Route::get('/future/courses/create', 'CourseSettingController@getFutureCourseCreate')->name('getFutureCourse.create')->middleware('RoutePermissionCheck:getFutureCourse');
    Route::post('/future/courses/store', 'CourseSettingController@getFutureCourseStore')->name('getFutureCourse.store')->middleware('RoutePermissionCheck:getFutureCourse');
    Route::get('/future/courses/{futureCourse}/edit', 'CourseSettingController@getFutureCourseEdit')->name('getFutureCourse.edit')->middleware('RoutePermissionCheck:getFutureCourse');
    Route::put('/future/courses/{futureCourse}/update', 'CourseSettingController@getFutureCourseUpdate')->name('getFutureCourse.update')->middleware('RoutePermissionCheck:getFutureCourse');
    Route::delete('/future/courses/{futureCourse}/destroy', 'CourseSettingController@getFutureCourseDestroy')->name('getFutureCourse.delete')->middleware('RoutePermissionCheck:getFutureCourse');
